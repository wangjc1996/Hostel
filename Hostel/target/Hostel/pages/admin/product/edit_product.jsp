...
<div class="wrapper">
    <div class="content">
        <div class="admin-panel">
            <h3 class="title">编辑产品</h3>
            <div class="normal-div">店面名称： ${shop.name}</div>
            <div class="normal-div">产品编号： ${product.id}</div>
            <label for="js-name-input" class="normal-input-label">产品名称</label>
            <input type="text" class="normal-input" id="js-name-input" value="${product.name}"/>
            <label for="js-desc-textarea" class="normal-input-label">产品描述</label>
            <textarea class="normal-textarea" id="js-desc-textarea" rows=5>${product.description}</textarea>
